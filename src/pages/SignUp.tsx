...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome to Sports Hub. Let's set up your preferences.",
    });
    navigate("/");
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-accent p-4">
      <Card className="w-full max-w-md" data-usecases="UC_269,UC_001">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Join Sports Hub to follow your favorite teams and players
          </CardDescription>
        </CardHeader>
        <CardContent>
