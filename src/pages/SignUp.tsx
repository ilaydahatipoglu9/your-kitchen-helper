...
import { Radio, Eye, EyeOff, UserPlus, Check } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Join Sports Hub to follow your favorite teams
            </CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    {passwordRequirements.map((req, index) => (
                      <div
                        ...
                        className={cn(
                          ...
                          req.met ? "text-maritime-success" : "text-muted-foreground"
                        )}
                      >
