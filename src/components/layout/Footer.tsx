...
export function Footer() {
  return (
    <footer className="bg-primary text-primary-foreground mt-auto">
      <div className="container mx-auto max-w-content px-4 md:px-6 lg:px-8">
        <div className="py-12 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <p className="text-sm text-white/70 max-w-xs">
              Your central destination for discovering, tracking, and staying informed about your favorite sports.
            </p>
          </div>
        ...
        <div className="py-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/60">
            {new Date().getFullYear()} Sports Hub. All rights reserved.
          </p>
